...
interface DateCounterStateType {
  count: number;
  step: number;
}

type ActionType = "dec" | "inc" | "setCount" | "setStep" | "reset";

interface DateCounterActionType {
  type: ActionType;
  payload?: number;
}
...
function reducer(
  state: DateCounterStateType,
  action: DateCounterActionType
): DateCounterStateType {
